...
import com.alexandercolen.LibraryTracker.services.BarcodeService;
...
public class BarcodeController {    
    ...
    public String decodeBarcode(@RequestParam(value = "image") String image_base64) {
        return this.barcodeService.decodeBarcode(image_base64);
    }
}
